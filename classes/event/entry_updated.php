...
class entry_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('evententryupdated', 'mod_testnntp');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/testnntp/edit.php', array('id' => $this->contextinstanceid));
    }
