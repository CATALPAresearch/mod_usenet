...
<div class="container">
     <div class="">
	 <div class="col-12" >
		<div class="col-xl-6 col-sm-12" id="tree" style="overflow-y:scroll; height:500px" >
			<div class=loading><i class="fas fa-cog fa-spin fa-5x"></i>loading
			</div>
                </div>
		<div class="col-xl-6 col-sm-12" id="treeinfo" style="overflow-y:scroll; height:500px">
		</div>
	</div>
    </div>
</div>
